...
INCBIN "gfx/footprints/egg_dex_monster.1bpp",      			footprint_top ;sub-cybr
INCBIN "gfx/footprints/egg_dex_monster.1bpp",     			footprint_top ;velocerace
INCBIN "gfx/footprints/egg_dex_ditto.1bpp",        			footprint_top ;missingNOWN

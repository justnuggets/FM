...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_GIRAFARIG,   115,  576 ; MOLUMENTAL
	mon_cry CRY_AIPOM,      -352,  384 ; VILEMENTAL
	mon_cry CRY_PICHU,      -538,  496 ; ALUMENTAL
	mon_cry CRY_AIPOM,        44,  264 ; SALAMENTAL
	mon_cry CRY_VILEPLUME,    32,  368 ; FARIMENTAL
	mon_cry CRY_GRIMER,       85,  129 ; CTRLBOT
	mon_cry CRY_RAICHU,      128,  192 ; ALTBOT
	mon_cry CRY_FEAROW,      255,  256 ; DELBOT
	mon_cry CRY_RAICHU,      248,  192 ; PUMMAT
	mon_cry CRY_BULBASAUR,    96,  192 ; TRAUMAT
	mon_cry CRY_BULBASAUR,    64,  256 ; ACROMAT
	mon_cry CRY_BULBASAUR,    60,  320 ; PARAGODA
	mon_cry CRY_PARAS,       153,  383 ; DOOMSTONE
	mon_cry CRY_PARAS,       238,  383 ; FEARTRESS
	mon_cry CRY_CHIKORITA,   -16,  176 ; GOTHEDRAL
	mon_cry CRY_CHIKORITA,   -34,  288 ; TSUKIMIKO
	mon_cry CRY_CHIKORITA,  -183,  512 ; ZONBI
	mon_cry CRY_CYNDAQUIL,   839,  128 ; SMOKAI
	...
	mon_cry CRY_AMPHAROS,      0,  352 ; PARRODISO
	mon_cry CRY_DUNSPARCE,   656,  168 ; POLLIROJER
	mon_cry CRY_AMPHAROS,     53,  224 ; FLAMAMIGO
	mon_cry CRY_WOOPER,       83,  175 ; CASSAVAGE
	mon_cry CRY_TEDDIURSA,  1954,  110 ; HARPSHOOTR
	mon_cry CRY_TEDDIURSA,  1600,  216 ; CURARIBRI
	mon_cry CRY_SLUGMA,     -472,  320 ; COCAPITAN
	mon_cry CRY_MAGCARGO,   -525,  448 ; TECNOCEROS
	mon_cry CRY_CYNDAQUIL,   510,  320 ; MEDISPRATE
